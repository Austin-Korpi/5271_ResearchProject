...
def main():
    # Parse the data
    libc = parse_data('blender_libc.txt')
    ffmalloc = parse_data('blender_ffmalloc.txt')
    ...
    plt.tight_layout()
    fig.suptitle('Blender Memory Usage Over Time', y=0.98)  # Add a title above the plots
